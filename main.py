...
<body>
  ...
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="kidx" class="form-label">ʜᴀᴛᴇʀꜱ ɴᴀᴍᴇ</label>
  ...
  <footer class="footer">
    ...
    <p> Contact:<a href="https://www.facebook.com/Asmit021">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://www.instagram.com/_datboii.asmit?igsh=MTN0N2Y5cDNqN2lvbw==" class="Instagram-link">
